    ...
    <div style="margin-bottom: 30px;" class="header Container-Title ">
        ...
        <div style="margin-top: 20px; width: 2000px;">
            ...
            <asp:Panel ID="TextBoxesPanel" runat="server" Style="display: inline-block;">
                ...
                <asp:DropDownList ID="MainGroupList" runat="server" Style="display: block; margin-bottom: 10px; width: 255px; height: 30px; font-size: 16px;" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="MainGroupListSelectedIndexChanged"></asp:DropDownList>
